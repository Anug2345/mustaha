  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 w-8 h-8 rounded-full border border-[#7C8F6A]/40 backdrop-blur-[0.5px] pointer-events-none"
      />
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 w-2 h-2 rounded-full bg-[#556447] shadow-[0_0_4px_rgba(85,100,71,0.5)] pointer-events-none"
      />
    </div>
  );
};

...
export const Services: React.FC<ServicesProps> = ({ onSelectService }) => {
  ...
  return (
    <section id="services" className="py-20 md:py-28 bg-[#F4F6F2]/70 dark:bg-[#151916]/80 border-t border-[#E2DFD8] dark:border-[#2B332C] relative overflow-hidden transition-colors">
      {/* Background ambient accents */}
      <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#E8EDE3]/40 dark:bg-[#7C8F6A]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-[#D3DCCB]/30 dark:bg-[#343D35]/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:items-end gap-2">
            <div className="text-xs text-[#6B7280] dark:text-[#9BA796] hidden md:block text-right">
              <span>Flexible Engagement Options</span>
              <p className="font-semibold text-[#1F2937] dark:text-[#F3F5F1] mt-0.5">Project-based • Ongoing Support • Contract</p>
            </div>
            ...
            {filteredServices.map((service) => {
              ...
              return (
                <InteractiveTiltCard
                  ...
                  maxTilt={6}
                  scale={1.025}
                  className="group bg-white dark:bg-[#1B201C] rounded-2xl p-7 border border-[#E2DFD8] dark:border-[#2B332C] shadow-2xs hover:shadow-xl hover:border-[#7C8F6A] dark:hover:border-[#7C8F6A] transition-colors duration-200 flex flex-col justify-between relative overflow-hidden"
                >
                  <div>
                    ...
                    <div className="flex items-center justify-between gap-2 mb-5">
                      <motion.div 
                        ...
                        className="w-12 h-12 rounded-xl bg-[#E8EDE3] dark:bg-[#222823] flex items-center justify-center group-hover:bg-[#7C8F6A] group-hover:text-white transition-colors duration-200 shadow-2xs"
                      >
                        <span className="group-hover:brightness-200 transition-all">
                          {getIcon(service.iconName)}
                        </span>
                      </motion.div>
                      <span className="px-2.5 py-1 rounded-md bg-[#F8F7F4] dark:bg-[#161A17] border border-[#E2DFD8] dark:border-[#2B332C] text-[11px] font-semibold text-[#4B5563] dark:text-[#9BA796]">
                        {service.tag}
                      </span>
                    </div>
                    ...
                    <div className="mt-6 pt-5 border-t border-[#E2DFD8]/70 dark:border-[#2B332C]">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="text-xs font-bold text-[#1F2937] dark:text-[#F3F5F1] uppercase tracking-wider">
                          Key Deliverables:
                        </h4>
                        <span className="text-[10px] text-[#6B7280] dark:text-[#9BA796] italic">
                          Click to select
                        </span>
                      </div>
                            ...
                            <li key={idx}>
                              <button
                                ...
                                className={`w-full text-left flex items-start gap-2.5 p-1.5 rounded-lg transition-all cursor-pointer ${
                                  isChecked 
                                    ? 'bg-[#E8EDE3]/60 dark:bg-[#222823]/80 text-[#1F2937] dark:text-[#F3F5F1]' 
                                    : 'hover:bg-[#F8F7F4] dark:hover:bg-[#161A17] text-[#4B5563] dark:text-[#9BA796]'
                                }`}
                              >
                                <motion.span 
                                  ...
                                  className={`w-4 h-4 rounded-full flex items-center justify-center shrink-0 mt-0.5 border transition-colors ${
                                    isChecked
                                      ...
                                      : 'border-[#D1D5DB] dark:border-[#3E493F] bg-white dark:bg-[#161A17]'
                                  }`}
                                >
                                  {isChecked ? (
                                ...
                                <span className={`text-xs leading-relaxed ${isChecked ? 'font-medium text-[#1F2937] dark:text-[#F3F5F1]' : ''}`}>
                                  {task}
                                </span>
                              </button>
                            </li>
                  ...
                  <div className="mt-8 pt-5 border-t border-[#E2DFD8]/60 dark:border-[#2B332C]">
                    <motion.button
                      ...
                      className="w-full flex items-center justify-between px-4 py-2.5 rounded-xl bg-[#F8F7F4] dark:bg-[#161A17] text-[#1F2937] dark:text-[#F3F5F1] hover:bg-[#1F2937] dark:hover:bg-[#7C8F6A] hover:text-white dark:hover:text-white border border-[#E2DFD8] dark:border-[#2B332C] hover:border-[#1F2937] dark:hover:border-[#7C8F6A] text-xs font-semibold transition-all duration-200 cursor-pointer group/btn"
                    >
                      <span>
                      ...
                      <ArrowRight className="w-3.5 h-3.5 text-[#7C8F6A] dark:text-[#A3B899] group-hover/btn:text-white group-hover/btn:translate-x-0.5 transition-all" />
                    </motion.button>
                  </div>
                </InteractiveTiltCard>
              );
